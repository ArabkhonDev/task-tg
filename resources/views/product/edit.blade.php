<x-app-layout>
    <div class="my-5">
        <div
            ...
            <a href="{{route('products.show', ['product'=> $product->id])}}" class="px-4 py-2 bg-red-500 rounded-md text-white text-sm sm:text-lg shadow-md">Go Back</a>
            <div class="my-3">
                <!-- Form title -->
                ...
                <form action="{{ route('products.update', ['product'=> $product->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="my-2">
                        ...
                        <input type="file" name="class" value="{{$product->image}}"
                            class="block w-full border border-emerald-500 outline-emerald-800 px-2 py-2 text-sm sm:text-md rounded-md my-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                            id="image">
                    </div>
